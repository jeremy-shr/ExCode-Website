...
const R2 = styled.section`
	background-image: url("/background-pic-cropped.jpg");
					...
					<div>
						...
						<div style={{ maxWidth: 600, marginLeft: 163 }}>
							<Paragraph>
								...
								adipisicing elit. Laboriosam quaerat dolor, unde
								sunt possimus eum, ipsum quibusdam totam cum
								ullam voluptatem consequuntur reiciendis,
								mollitia animi hic id velit! Molestias, ipsa.
							</Paragraph>
						</div>
					</div>
				</div>
