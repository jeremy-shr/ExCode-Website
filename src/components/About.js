				...
				<TitleContain className="container-fluid">
					<div className="container">
						...
						<p style={{ width: "500" }}>
							...
							to be able to learn to code. The potential was clear
							so through the Exeter Entrepreneurs community
							backing, rising popularity and belief in the
							project, ExCode is now recognised as the leading
							student-run coding bootcamp in the UK. We are fully
							aware that the majority of coding bootcamps and
							computer-science degree programs come with massive
							financial paywalls, therefore we are committed to
							being completely FREE to ensure anyone can enroll in
							our bootcamp. This is thanks to our many sponsors
							who continue to support the programs and believe in
							our mission. We are currently partnered with the
							Exeter Artificial Intelligence society (X-AI) to
							deliver our course fully in Python, the most
							accessible programming language for learners and are
							backed by the University of Exeter to help foster
							core programming concepts across all the academic
							colleges.
						</p>
					</div>
				</TitleContain>
